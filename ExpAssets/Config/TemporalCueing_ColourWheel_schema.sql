...
data in the database to text files found in TemporalCueing_ColourWheel/ExpAssets/Data.
...
CREATE TABLE trials (
    ...
    warning_validity text not null,
    foreperiod text not null,
    tone_onset text not null,
    target_duration text not null,
    target_colour text not null,
    response_colour text not null,
    response_angular_error text not null,
